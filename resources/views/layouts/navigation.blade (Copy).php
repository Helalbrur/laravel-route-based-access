...
<ul class="navbar-nav active">
    ...
    <li class="nav-item dropdown">
        <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <img class="rounded-circle header-profile-user" src="{{ URL::asset('skote/assets/images/users/avatar-1.jpg') }}" alt="Header Avatar">
            <span class="d-none d-xl-inline-block ms-1">@if (Auth::check()){{ Auth::user()->name }} @endif</span>
        ...
        <div class="dropdown-menu dropdown-menu-end">
            ...
            <form method="POST" action="{{ route('logout') }}">
                ...
                <a href="route('logout')" class="dropdown-item dropdown-footer"
                    ...
                    <i class="bx bx-log-out font-size-16 align-middle me-1"></i> {{ __('Log Out') }}
                </a>
            </form>
        </div>
    </li>
