                ...
                <div class="card-text">
                    <form name="mainform_1" id="mainform_1" autocomplete="off">
                        ...
                        <div class="form-group row">
                            ...
                            <label for="txt_buyer_name" class="col-sm-2 col-form-label must_entry_caption">Buyer Name</label>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group row">
                            ...
                            <label for="txt_buyer_address" class="col-sm-2 col-form-label">Address</label>
                            <div class="col-sm-4">
                        ...
                        <div class="from-group row">
                            ...
                            <div class="col-sm-7">
                                <?php
                                    echo load_submit_buttons( $permission, "fnc_buyer_name", 0,0 ,"reset_form('mainform_1','','',1)");
                                ?>
                            </div>
