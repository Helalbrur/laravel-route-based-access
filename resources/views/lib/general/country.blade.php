...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 align-center"><strong>Country Entry</strong></h1>
        </div>
    </div><!-- /.row -->
@endsection()
@section('content')
                ...
                <div class="card" style="background-color: #F5FFFA">
                    <form name="countryentry_1" id="countryentry_1" autocomplete="off" style="padding: 10px;">
                        ...
                        <div class="form-group row">
                            <label for="txt_country_name" class="col-sm-2 col-form-label must_entry_caption">Country Name</label>
                            <div class="col-sm-3">
