...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Receive Search</h5>
                <div class="card-text">
                    ...
                    <table id="list_view" class="table table-bordered" style="width: 100%">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="form-control form-control-sm" id="txt_receive_no" name="txt_receive_no" value="" placeholder="Receive No">
                                </td>
                                <td>
                                    <div class="d-flex">
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-sm btn-info" onClick="show_list_view( 
                                        JSON.stringify({
                                            ...
                                            txt_receive_no: document.getElementById('txt_receive_no').value,
                                            'txt_from_date': document.getElementById('txt_from_date').value,
                                            'txt_to_date': document.getElementById('txt_to_date').value
                                        }), 'order/receive_search_list_view', 'search_div', '', 'setFilterGrid(\'tbl_po_list\',-1)')">
                                        Show
                                    </button>
                                </td>
                            </tr>
