...
$item_category_id    = $param['item_category_id'] ?? 0;
?>
<div class="row">
    <div class="col-lg-10">
        <div class="card">
                            ...
                            <tr>
                                <td>
                                    <select class="form-control form-control-sm" id="cbo_item_category" name="cbo_item_category" style="width: 100%"
                                        ...
                                        <option value="{{$category_id}}" {{ ($category_id == $item_category_id) ? 'selected' : '' }}>{{$category_name}}</option>
                                        @endforeach
                                    </select>
                                </td>
                                ...
                                <td>
                                    <input type="text" class="form-control form-control-sm" id="txt_item_code" name="txt_item_code" placeholder="Item Code">
                                </td>
                                <td>
...
<script>
    ...
    async function handleCategoryChange() {
        try {
            ...
            }), 'product_under_category', 'product_div')
        } catch (error) {
