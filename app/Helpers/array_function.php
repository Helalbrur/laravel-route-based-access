...
{
    return array(1 => "Group Profile", 2 => "Company Profile", 3 => "Item Group", 4 => "Item Sub Group", 5 => "Country" , 6 => "Color", 7 => "Size", 8 => "Location", 9 => "Buyer Profile", 10 => "Supplier Profile", 11 => "Brand Entry");
}
