...
function get_uom()
{
    return App\Models\LibUom::pluck('uom_name', 'id')->toArray();
...
{
    return array(1 => "Group Profile", 2 => "Company Profile", 3 => "Item Group", 4 => "Item Sub Group", 5 => "Country" , 6 => "Color", 7 => "Size", 8 => "Location", 9 => "Buyer Profile", 10 => "Supplier Profile", 11 => "Brand Entry", 12 => "Work Order", 13 => "Item Creation",14=>"Receive",15=>"Issue",16=>"Requisition",17=>"Transfer");
}
...
{
    return App\Models\ProductDetailsMaster::pluck('item_description', 'id')->toArray();
}
